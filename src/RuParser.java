// Generated from D:/giova/Documents/IntelliJ_Proyects/proyectoTraductores/src\Ru.g4 by ANTLR 4.10.1
...
public class RuParser extends Parser {
	...
	public final BloqueContext bloque() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << IF) | (1L << WHILE) | (1L << LOG) | (1L << IMPRIMIR) | (1L << ID) | (1L << OTRO))) != 0)) {
				{
				{
				setState(27);
				sentencia();
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 4:
						...
						_la = _input.LA(1);
						if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << MAYORQ) | (1L << MENORQ) | (1L << MENIG) | (1L << MAYIG))) != 0)) ) {
